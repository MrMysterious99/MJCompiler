...
public class MethodVarDeclRecursion extends MethodVarDecl {

    private MethodVarDecl MethodVarDecl;
    private VarDecl VarDecl;

    public MethodVarDeclRecursion (MethodVarDecl MethodVarDecl, VarDecl VarDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MethodVarDeclRecursion(\n");
