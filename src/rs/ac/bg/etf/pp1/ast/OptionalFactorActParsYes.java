...
public class OptionalFactorActParsYes extends OptionalFactorActPars {

    private ActParsOptional ActParsOptional;

    public OptionalFactorActParsYes (ActParsOptional ActParsOptional) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("OptionalFactorActParsYes(\n");
