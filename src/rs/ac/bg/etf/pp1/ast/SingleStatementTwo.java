...
public class SingleStatementTwo extends SingleStatement {

    private Condition Condition;
    private Statement Statement;
    private OptionalElse OptionalElse;

    public SingleStatementTwo (Condition Condition, Statement Statement, OptionalElse OptionalElse) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("SingleStatementTwo(\n");
