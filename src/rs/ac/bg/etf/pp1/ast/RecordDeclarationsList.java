...
public class RecordDeclarationsList extends DeclList {

    private DeclList DeclList;
    private RecordDecl RecordDecl;

    public RecordDeclarationsList (DeclList DeclList, RecordDecl RecordDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("RecordDeclarationsList(\n");
