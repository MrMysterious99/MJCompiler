...
public class RecordVarDeclRecursion extends RecordVarDecl {

    private RecordVarDecl RecordVarDecl;
    private VarDecl VarDecl;

    public RecordVarDeclRecursion (RecordVarDecl RecordVarDecl, VarDecl VarDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("RecordVarDeclRecursion(\n");
