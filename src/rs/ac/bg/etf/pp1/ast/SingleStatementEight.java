...
public class SingleStatementEight extends SingleStatement {

    private Expr Expr;
    private OptionalNumConst OptionalNumConst;

    public SingleStatementEight (Expr Expr, OptionalNumConst OptionalNumConst) {
        this.Expr=Expr;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("SingleStatementEight(\n");
